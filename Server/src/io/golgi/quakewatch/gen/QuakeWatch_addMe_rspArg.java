...
public class QuakeWatch_addMe_rspArg
{
    ...
    public QuakeWatch_addMe_rspArg(){
        this(true);
    }

    public QuakeWatch_addMe_rspArg(boolean isSetDefault){
        super();
    ...
    public QuakeWatch_addMe_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public QuakeWatch_addMe_rspArg(String payload){
