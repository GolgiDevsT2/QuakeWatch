...
public class QuakeWatch_removeMe_reqArg
{
    ...
    public QuakeWatch_removeMe_reqArg(){
        this(true);
    }

    public QuakeWatch_removeMe_reqArg(boolean isSetDefault){
        super();
        golgiIdIsSet = isSetDefault;
        golgiId = new String();
    }

    public QuakeWatch_removeMe_reqArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public QuakeWatch_removeMe_reqArg(String payload){
