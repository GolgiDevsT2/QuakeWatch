...
public class QuakeWatch_quakeAlert_rspArg
{
    ...
    public QuakeWatch_quakeAlert_rspArg(){
        this(true);
    }

    public QuakeWatch_quakeAlert_rspArg(boolean isSetDefault){
        super();
    ...
    public QuakeWatch_quakeAlert_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public QuakeWatch_quakeAlert_rspArg(String payload){
