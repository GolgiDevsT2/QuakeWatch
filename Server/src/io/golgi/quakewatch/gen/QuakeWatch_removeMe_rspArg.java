...
public class QuakeWatch_removeMe_rspArg
{
    ...
    public QuakeWatch_removeMe_rspArg(){
        this(true);
    }

    public QuakeWatch_removeMe_rspArg(boolean isSetDefault){
        super();
    ...
    public QuakeWatch_removeMe_rspArg(GolgiPayload payload){
        this(false);
        deserialise(payload);
    }

    public QuakeWatch_removeMe_rspArg(String payload){
